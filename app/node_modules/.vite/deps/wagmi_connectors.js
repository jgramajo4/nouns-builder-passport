...
import {
  ...
  call_exports,
  mini_exports
} from "./chunk-OWVN5E4X.js";
import "./chunk-E4AYQST3.js";
import "./chunk-ANJCMEYS.js";
import "./chunk-TEPWYFYD.js";
import {
...
import {
  ...
  polygonAmoy,
  sepolia
} from "./chunk-TF3ICLFY.js";
import "./chunk-EFFWOGFH.js";
import "./chunk-OR2EHVOU.js";
import {
  withRetry,
  withTimeout
} from "./chunk-YNPEMKGI.js";
import "./chunk-XFF7OJZQ.js";
import "./chunk-EDZ6DH26.js";
import {
...
import {
  require_semver
} from "./chunk-QFE7ZLFF.js";
import {
  keccak_256
} from "./chunk-5P7C4ALA.js";
import {
  __commonJS,
  __export,
  __toESM
  ...
  "node_modules/lodash/lodash.js"(exports, module) {
    (function() {
      ...
      var runInContext = function runInContext2(context) {
        ...
        function parseInt2(string2, radix3, guard) {
        ...
        function mixin(object3, source, options) {
          ...
          var chain3 = !(isObject3(options) && "chain" in options) || !!options.chain, isFunc = isFunction(object3);
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createBaseAccountSDK } = await import("./dist-TMIABZMW.js");
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-XGT7MRVM.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-VPTCR2OG.js");
...
var GeminiWallet = class {
  constructor({ appMetadata, chain: chain2, onDisconnectCallback, storage }) {
    this.accounts = [];
    ...
    const fallbackChainId = (chain2 == null ? void 0 : chain2.id) ?? DEFAULT_CHAIN_ID;
    const fallbackRpcUrl = (chain2 == null ? void 0 : chain2.rpcUrl) ?? getDefaultRpcUrl(fallbackChainId);
    const defaultChain = {
      id: fallbackChainId,
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-CS5UO23A.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
    ...
    return {
      ...
      async getPortoInstance() {
        porto_promise ?? (porto_promise = (async () => {
          const { Porto } = await import("./dist-LW2CFL3B.js");
          return Porto.create({
            ...parameters,
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-LDCDG7WY.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-5CNKXMIW.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-4WA7KKEK.js");
