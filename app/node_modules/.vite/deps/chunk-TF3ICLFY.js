import {
  FeeCapTooHighError as FeeCapTooHighError2,
  InvalidChainIdError as InvalidChainIdError2,
  InvalidSerializedError,
  TipAboveFeeCapError as TipAboveFeeCapError2,
  fromRpc as fromRpc2,
  fromRpc2 as fromRpc4,
  fromRpcType,
  fromTupleList,
  toRpc as toRpc2,
  toRpc2 as toRpc4,
  toRpcType,
  toTupleList
} from "./chunk-EFFWOGFH.js";
import {
  fromRpc2 as fromRpc3,
  fromRpcType as fromRpcType2,
  toRpc2 as toRpc3,
  toRpcType as toRpcType2,
  verify as verify2,
  verify2 as verify3
} from "./chunk-OR2EHVOU.js";
import {
...
function assert4(envelope) {
  ...
  if (type2 === "p256") {
    const p256 = envelope;
    const missing = [];
    if (typeof ((_a2 = p256.signature) == null ? void 0 : _a2.r) !== "bigint")
...
function fromRpc5(envelope) {
  ...
  if (envelope.type === "keychain" || "userAddress" in envelope && "signature" in envelope)
    return {
      ...
      inner: fromRpc5(envelope.signature),
...
function validate4(tempoAddress) {
  try {
    parse(tempoAddress);
    return true;
  } catch {
...
function fromRpc6(authorization) {
  ...
  const signature = fromRpc5(authorization.signature);
  return {
    address,
...
function fromRpc8(transaction, _options = {}) {
  if (!transaction)
    return null;
  const transaction_ = fromRpc2(transaction);
  ...
  if (transaction.signature)
    transaction_.signature = fromRpc5(transaction.signature);
  ...
  if (transaction.keyAuthorization)
    transaction_.keyAuthorization = fromRpc7(transaction.keyAuthorization);
...
function toRpc8(transaction, _options) {
  var _a2;
  const rpc = toRpc2(transaction);
  rpc.type = toRpcType3[transaction.type];
  if (transaction.authorizationList)
    rpc.aaAuthorizationList = toRpcList(transaction.authorizationList);
  if (transaction.calls)
...
function fromRpc9(receipt) {
  return fromRpc3(receipt);
}
function toRpc9(receipt) {
  const rpc = toRpc3(receipt);
  return {
    ...rpc,
...
function fromRpc10(request) {
  ...
  if (request.keyAuthorization)
    request_.keyAuthorization = fromRpc7(request.keyAuthorization);
...
function deserialize3(serialized) {
  ...
  if (feePayerSignatureOrSender !== "0x" && feePayerSignatureOrSender !== void 0) {
    if (feePayerSignatureOrSender === "0x00" || validate2(feePayerSignatureOrSender)) {
      transaction.feePayerSignature = null;
      if (validate2(feePayerSignatureOrSender))
...
var fieldsSize = 29;
var version = 0;
function from12(authentication, options = {}) {
...
function serialize5(authentication, options = {}) {
  ...
  return concat(serialize(from5(signature)), getFields(authentication));
}
...
//# sourceMappingURL=chunk-TF3ICLFY.js.map
